...
RICE_UREA_KG_ACRE = 180 / 2.471
RICE_TSP_KG_ACRE = 43 / 2.471
RICE_MOP_KG_ACRE = 42 / 2.471
RICE_FERTILIZER_COST_PER_ACRE = round(
    RICE_UREA_KG_ACRE * FERTILIZER_PRICE_BDT_PER_KG["urea"]
    + RICE_TSP_KG_ACRE * FERTILIZER_PRICE_BDT_PER_KG["tsp"]
    + RICE_MOP_KG_ACRE * FERTILIZER_PRICE_BDT_PER_KG["mop"],
    2,
)  # ~2792 BDT/acre
